...
def test_outdated_products_identifies_expired_items() -> None:
    ...
    # Usamos un Mock específico para la clase date
    mock_date_class = MagicMock(wraps=datetime.date)
    mock_date_class.today.return_value = datetime.date(2022, 2, 2)

    with patch("app.main.datetime.date", mock_date_class):
